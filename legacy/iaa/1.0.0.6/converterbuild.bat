...
REM BFCPEEXE=C:\Users\Zwemer\Documents\Adriaan\CWPrograms\iaa\1.0.0.6\IaA-1.0.0.6.exe
REM BFCPEICON=C:\Users\Zwemer\Documents\Adriaan\icon.ico
...
REM BFCPEVERVERSION=1.0.0.6
REM BFCPEVERPRODUCT=Image and Archive
REM BFCPEVERDESC=Combine images and archives to hide them
REM BFCPEVERCOMPANY=Bunnyprojects
REM BFCPEVERCOPYRIGHT=(c) unregisterd Adriaan Zwemer
REM BFCPEOPTIONEND
@ECHO ON
@Echo off
color f0
